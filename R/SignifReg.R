SignifReg <-
  function(scope,data,alpha = 0.05,direction = "forward",criterion = "p-value",correction = "FDR")UseMethod("SignifReg")
    

SignifReg.default <-
  function(scope,data,alpha = 0.05,direction = "forward",criterion = "p-value",correction = "FDR"){
